  ...
  map(.f = function(a) {
    ...
    output =
      train(el_rides ~ .,
            ...
            # preProcess = c("nzv", "center", "scale", "medianImpute"),
            na.action = na.pass,
            method = "rf",
            metric = "RMSE",
            maximize = FALSE,
...
# user  system elapsed 
#  69.509   6.675 537.883 
# ~ 9 min 
message("time.Rf.corr_yes")
time.Rf.corr_yes

# user  system elapsed 
#  45.860   2.914 514.294
# ~ 9 min
...
saveRDS(DV_Fit.Rf.corr_yes,
        paste0(wd,
               "/Data_Processed/",
               "DV_Fit.Rf.corr_yes.Rds"
               )
        )
