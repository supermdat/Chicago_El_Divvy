...
#                b = names(automl_leader)
#                ),
#      .f = function(a, b) {
#        h2o.saveModel(object = a,
#                      path = paste0(wd,
#                                    "/Models/",
#                                    b,
#                                    "_"#,
...
# automl_leader <-
#   h2o.loadModel(path = paste0(wd,
#                               "/Models/",
#                               "GBM_grid_0_AutoML_20181009_102645_model_0"
#                               )
#                 )
...
h2o_forecasts <-
  pmap(.l = list(a = h2o_data,
       ...
       .f = function(a, b) {
         ...
         # interp_data_h2o$`40600`$interp_data[[1]] %>% as.data.frame() %>% select(el_rides)
         int_data =
...
# h2o_forecasts$`40600` %>% names()
# h2o_forecasts$`40600`$h2o.interp.forecast[[1]] %>%
#   pull(sqrd_error) %>% 
#   mean(na.rm = TRUE) %>%
#   sqrt()
...
# h2o.limvars_forecasts$`40600` %>% names()
# h2o.limvars_forecasts$`40600`$h2o.interp.forecast[[1]] %>%
#   pull(sqrd_error) %>% 
#   mean(na.rm = TRUE) %>%
#   sqrt()
...
func_get_forecast_data <-
  ...
  # add_el_stop_id$`40600`$h2o.limvars.extrap.forecast[[1]] %>% str()
  data_h2o_list = 
