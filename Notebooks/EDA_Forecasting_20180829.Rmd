...
### Holidays
  ...
  Here I simply take the 7-day lag of the holiday-related variables.
```{r}
...
six_stations_all_lags <-
  pmap(.l = list(a = six_stations_divvy_data_lags),
       .f = function(a) {
         dat = a %>% 
           mutate( holiday_name_l7 = dplyr::lag(holiday_name, n = 7),
...
## Save the data to the proper folder
saveRDS(six_stations_all_lags,
        paste0(wd,
               "/Data/Interim/",
               "six_stations_all_lags.Rds"
               )
        )
